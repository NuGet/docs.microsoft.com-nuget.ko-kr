...
### [Visual Studio용 NuGet 자격 증명 공급 기업](reference/extensibility/nuget-credential-providers-for-visual-studio.md)
### [nuget.exe 자격 증명 공급 기업](reference/extensibility/nuget-exe-credential-providers.md)
## 보관된 내용
### [project.json 관리 형식](archive/project-json.md)
### [project.json 및 UWP](archive/project-json-and-uwp.md)
### [project.json 영향](archive/project-json-impact.md)
# API
## [개요](api/overview.md)
## 자료
