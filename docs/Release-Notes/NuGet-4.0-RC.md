...
---
# <a name="40-rc-release-notes"></a>4.0 RC 릴리스 정보
...
* dotnet pack3에는 기본적으로 XML 문서가 포함되어야 합니다. - [#3698](https://github.com/NuGet/Home/issues/3698)
...
* 유동적인 버전이 사용되는 경우 dotnet restore에서 단순 목록 로컬 리포지토리에 대해 대/소문자를 구분하는 ID 조회를 수행합니다. - [#2516](https://github.com/NuGet/Home/issues/2516)
...
* dotnet restore3 foo.csproj는 projectref 종속성을 따르고 이를 복원해야 합니다. 빌드하는 경우도 마찬가지입니다. - [#3577](https://github.com/NuGet/Home/issues/3577)
