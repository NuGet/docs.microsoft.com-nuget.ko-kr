...
---
# <a name="40-rtm-release-notes"></a>4.0 RTM 릴리스 정보
...
### <a name="msbuild-trestore-fails-when-a-project-targeting-net461-references-another-project-targeting-netstandard"></a>.NET461을 대상으로 하는 프로젝트가 .NETStandard를 대상으로 하는 다른 프로젝트를 참조하는 경우 `msbuild /t:restore`가 실패함
