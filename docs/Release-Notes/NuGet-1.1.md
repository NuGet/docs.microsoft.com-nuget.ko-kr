...
* 먼저 이전 빌드를 제거 합니다. VS이 작업을 수행 하려면 관리자 권한으로 실행 해야 합니다.
...
* OData 서비스 끝점에 atom에서 피드 패키지 전환: CTP2 버전의 NuGet 업그레이드 하는 경우 수를 패키지 소스로 다음 URL을 추가 해야: [http://go.microsoft.com/fwlink/?LinkID=204820](http://go.microsoft.com/fwlink/?LinkID=204820)합니다.
