...
5. [https://www.nuget.org/account/transform](https://www.nuget.org/account/transform)로 이동합니다. 그러면 Microsoft 계정에 연결하지 않고서 nuget.org 계정을 조직 계정으로 변환할 수 있습니다.
