...
## <a name="general-form-and-schema"></a><span data-ttu-id="f21a0-117">일반 형식 및 스키마</span><span class="sxs-lookup"><span data-stu-id="f21a0-117">General form and schema</span></span>
...
### <a name="required-metadata-elements"></a><span data-ttu-id="f21a0-136">필수 metadata 요소</span><span class="sxs-lookup"><span data-stu-id="f21a0-136">Required metadata elements</span></span>
...
| <span data-ttu-id="f21a0-186">**serviceable**</span><span class="sxs-lookup"><span data-stu-id="f21a0-186">**serviceable**</span></span> | <span data-ttu-id="f21a0-187">*(3.3 이상)* NuGet 내부 전용입니다.</span><span class="sxs-lookup"><span data-stu-id="f21a0-187">*(3.3+)* For internal NuGet use only.</span></span> |
...
| <span data-ttu-id="f21a0-283">모두</span><span class="sxs-lookup"><span data-stu-id="f21a0-283">all</span></span> | <span data-ttu-id="f21a0-284">모든 폴더</span><span class="sxs-lookup"><span data-stu-id="f21a0-284">All folders</span></span> |
...
<span data-ttu-id="f21a0-303">마찬가지로 명시적 참조는 런타임 어셈블리 옆에 있는 도구 어셈블리가 필요하지만 프로젝트 참조로 포함될 필요가 없는 XUnit과 같은 단위 테스트 프레임워크에 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="f21a0-303">Similarly, explicit references can be used for unit test frameworks, such as XUnit, which needs its tools assemblies located next to the runtime assemblies, but does not need them included as project references.</span></span>
...
<span data-ttu-id="f21a0-352">**단일 어셈블리**</span><span class="sxs-lookup"><span data-stu-id="f21a0-352">**Single assembly**</span></span>
...
<span data-ttu-id="f21a0-370">**기본 콘텐츠 파일**</span><span class="sxs-lookup"><span data-stu-id="f21a0-370">**Basic content files**</span></span>
...
<span data-ttu-id="f21a0-375">**확장명이 없는 콘텐츠 파일**</span><span class="sxs-lookup"><span data-stu-id="f21a0-375">**Content files without extensions**</span></span>
...
#### <a name="package-folder-structure"></a><span data-ttu-id="f21a0-407">패키지 폴더 구조</span><span class="sxs-lookup"><span data-stu-id="f21a0-407">Package folder structure</span></span>
...
<span data-ttu-id="f21a0-413">빈 폴더는 `.`을 사용하여 언어 및 TxM의 특정 조합에 대한 콘텐츠 제공을 거부할 수 있습니다. 예를 들어 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="f21a0-413">Empty folders can use `.` to opt out of providing content for certain combinations of language and TxM, for example:</span></span>

    /contentFiles/vb/any/code.vb
    /contentFiles/cs/any/.

#### <a name="example-contentfiles-section"></a><span data-ttu-id="f21a0-414">contentFiles 섹션 예제</span><span class="sxs-lookup"><span data-stu-id="f21a0-414">Example contentFiles section</span></span>
...
## <a name="example-nuspec-files"></a><span data-ttu-id="f21a0-415">.nuspec 파일 예제</span><span class="sxs-lookup"><span data-stu-id="f21a0-415">Example .nuspec files</span></span>

<span data-ttu-id="f21a0-416">**dependencies 또는 files를 지정하지 않은 간단한 `.nuspec`**</span><span class="sxs-lookup"><span data-stu-id="f21a0-416">**A simple `.nuspec` that does not specify dependencies or files**</span></span>
...
<span data-ttu-id="f21a0-417">**dependencies가 있는 `.nuspec`**</span><span class="sxs-lookup"><span data-stu-id="f21a0-417">**A `.nuspec` with dependencies**</span></span>
...
<span data-ttu-id="f21a0-418">**files가 있는 `.nuspec`**</span><span class="sxs-lookup"><span data-stu-id="f21a0-418">**A `.nuspec` with files**</span></span>
...
<span data-ttu-id="f21a0-419">**프레임워크 어셈블리가 있는 `.nuspec`**</span><span class="sxs-lookup"><span data-stu-id="f21a0-419">**A `.nuspec` with framework assemblies**</span></span>
...
<span data-ttu-id="f21a0-420">이 예제에서는 특정 프로젝트 대상에 대해 다음이 설치됩니다.</span><span class="sxs-lookup"><span data-stu-id="f21a0-420">In this example, the following are installed for specific project targets:</span></span>

- <span data-ttu-id="f21a0-421">.NET4 -> `System.Web`, `System.Net`</span><span class="sxs-lookup"><span data-stu-id="f21a0-421">.NET4 -> `System.Web`, `System.Net`</span></span>
- <span data-ttu-id="f21a0-422">.NET4 클라이언트 프로필 -> `System.Net`</span><span class="sxs-lookup"><span data-stu-id="f21a0-422">.NET4 Client Profile -> `System.Net`</span></span>
- <span data-ttu-id="f21a0-423">Silverlight 3 -> `System.Json`</span><span class="sxs-lookup"><span data-stu-id="f21a0-423">Silverlight 3 -> `System.Json`</span></span>
- <span data-ttu-id="f21a0-424">Silverlight 4 -> `System.Windows.Controls.DomainServices`</span><span class="sxs-lookup"><span data-stu-id="f21a0-424">Silverlight 4 -> `System.Windows.Controls.DomainServices`</span></span>
- <span data-ttu-id="f21a0-425">WindowsPhone -> `Microsoft.Devices.Sensors`</span><span class="sxs-lookup"><span data-stu-id="f21a0-425">WindowsPhone -> `Microsoft.Devices.Sensors`</span></span>
