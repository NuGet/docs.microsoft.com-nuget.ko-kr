...
## <a name="parameters"></a><span data-ttu-id="4fdaf-109">매개 변수</span><span class="sxs-lookup"><span data-stu-id="4fdaf-109">Parameters</span></span>
