1. <span data-ttu-id="fbf42-101">`.nupkg` 파일을 포함하는 폴더로 변경합니다.</span><span class="sxs-lookup"><span data-stu-id="fbf42-101">Change to the folder containing the `.nupkg` file.</span></span>
